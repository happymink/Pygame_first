...
#스프라이트(캐릭터) 불러오기
character = pygame.image.load("C:/Users/민균/Desktop/Pygame_first/character.png")
...
#적 캐릭터 enemy
enemy = pygame.image.load("C:/Users/민균/Desktop/Pygame_first/enemy.png")
...
while running:
    ...
    timer = game_font.render(str(int (total_time - elapsed_time)), True, (255,255,255) )  #초단위로 하기위해 인트형으로 형변환 
    #출력할 글자 , True, 글자 색상
